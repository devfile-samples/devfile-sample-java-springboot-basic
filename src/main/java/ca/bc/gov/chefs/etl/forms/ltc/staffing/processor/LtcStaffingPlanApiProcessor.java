...
public class LtcStaffingPlanApiProcessor implements Processor{

	private Map<String,String> sharedData;
	public LtcStaffingPlanApiProcessor(Map<String, String> sharedData) {
	...
	public void process(Exchange exchange) throws Exception {
		...
		String uri = PropertiesUtil.getValue(Constants.CHEFS_API_URL).formatted(PropertiesUtil.getValue(Constants.LTC_STAFFING_PLAN_USERNAME), payload.getVersion(),payload.getStartDate(),payload.getEndDate());
