...
HEADERS.put(LTC_BUDGET_SUBMISSION,
				new String[] { "CONFIRMATION_ID", "IS_DELETED", "SUBMISSION_DATE", "SUBMITTED_BY", "CCIMS_ID", "SUBMISSION_TYPE", 
						"SUBMISSION_FY", "NB_TOTAL_BEDS", "NB_FUNDED_BEDS", "TOTAL_BENEFITS", "TOTAL_SALARIES_WAGES", "BENEFITS_PERCENT"});

		HEADERS.put(LTC_BUDGET_REV, new String[] { "CONFIRMATION_ID", "REV_TYPE", "REV_NAME", "REV", "REV_NOTES", });

		HEADERS.put(LTC_BUDGET_REV_SUBTOTALS, new String[] { "CONFIRMATION_ID", "REV_TYPE", "SUB_TOTAL_REV", "SUB_TOTAL_REV_NOTES"});

		HEADERS.put(LTC_BUDGET_EXP, new String[] { "CONFIRMATION_ID", "EXP_TYPE", "EXP_NAME", "EXP", "EXP_NOTES", });

		HEADERS.put(LTC_BUDGET_EXP_SUBTOTALS, new String[] { "CONFIRMATION_ID", "EXP_TYPE", "SUB_TOTAL_EXP", "SUB_TOTAL_EXP_NOTES"});
		
		HEADERS.put(LTC_BUDGET_DEP, new String[] { "CONFIRMATION_ID", "DEP_NAME", "DEP", "DEP_NOTES"});
		
		HEADERS.put(LTC_BUDGET_DEP_SUBTOTALS, new String[] { "CONFIRMATION_ID", "SUB_TOTAL_DEP", "SUB_TOTAL_DEP_NOTES"});
		
		HEADERS.put(LTC_BUDGET_SUM_TOTALS, new String[] { "CONFIRMATION_ID", "TOT_NAME", "SUM","TOT_NOTES"});
		...
		new String[] { "Confirmation_ID", "Comp_Sal_Type", "Sub_Total_Comp_Sal_Staff",
				"Sub_Total_Comp_Sal_Contract_Services", "Sub_Total_Comp_Sal_Total_Cost" });

		HEADERS.put(LTC_BUDGET_COMP_SAL_TOTALS,
		new String[] { "Confirmation_ID", "Comp_Sal_Total_Type", "Total_Comp_Sal_Staff",
				"Total_Comp_Sal_Contract_Services", "Total_Comp_Sal_Total_Cost" });
		...
		HEADERS.put(LTC_BUDGET_COMP_HRS_SUBTOTALS,
				new String[] { "Confirmation_ID", "Comp_Hrs_Type", "Sub_Total_Comp_Hrs_Staff",
						"Sub_Total_Comp_Hrs_Contract_Services", "Sub_Total_Comp_Total_Worked_Hrs", });
