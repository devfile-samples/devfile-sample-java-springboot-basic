	...
	static {
		...
		HEADERS.put(LTC_YTD_SUBMISSION,
				new String[] { "CONFIRMATION_ID", "IS_DELETED", "SUBMISSION_DATE", "SUBMITTED_BY", "CCIMS_ID", "SUBMISSION_TYPE", 
						"PERIOD","SUBMISSION_FY", "NB_TOTAL_BEDS", "NB_FUNDED_BEDS", "OCC_RATE_THRESHOLD", "TOTAL_SALARIES_WAGES",
						"TOTAL_BENEFITS", "BENEFITS_PERCENT" });

		HEADERS.put(LTC_YTD_REV, new String[] { "CONFIRMATION_ID", "REV_TYPE", "REV_NAME", "REV_YTD", "REV_NOTES", });

		HEADERS.put(LTC_YTD_REV_SUB_TOTALS, new String[] { "CONFIRMATION_ID", "REV_TYPE", "SUB_TOTAL_REV_YTD", "SUB_TOTAL_REV_NOTES"});
		...
		HEADERS.put(LTC_YTD_DIRECT_CARE_HRS, new String[] { "CONFIRMATION_ID", "DIR_CARE_TYPE", "DIR_CARE_NAME", "DIR_CARE_OTHER_VALUE",
				...
				"DIR_CARE_PROD_HRS_SUBTOTAL_YTD", "DIR_CARE_PROD_HRS_AGENCY_STUFF_UTIL_YTD", "DIR_CARE_PROD_HRS_TOTAL_YTD", "DIR_CARE_NON_PROD_HRS_VAC_YTD",
		...
		new String[] { "CONFIRMATION_ID", "DIR_CARE_COST_TYPE", "DIR_CARE_COST_NAME","DIR_CARE_OTHER_VALUE",
				...
				"DIR_CARE_COST_PROD_HRS_AGENCY_STUFF_UTIL_YTD",
